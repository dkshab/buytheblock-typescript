  ...
  return (
    <div className="Home">
      ...
      <div className="Home__section1">
        ...
        <div className="Home__section1__container">
          <div>
            <h4>The Challenge</h4>
            <p>
              Many first time home buyers don’t know the first thing to do when
              it comes to buying a property.
            </p>
            <p>
              The few that have a basic understanding often make their purchase
              in the wrong areas and more often than not end up overpaying for a
              property because they don’t have the right information to make an
              informed decision.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              that our home buyers are protected throughout the process and are
              provided with the correct information needed to make sound
      ...
      <div className="Home__section2">
        <div className="Home__section2__signup">
        ...
        <div className="Home__section2__started">
